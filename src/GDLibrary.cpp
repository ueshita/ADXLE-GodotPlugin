...
extern "C" void GDN_EXPORT adxle_gdnative_init(godot_gdnative_init_options *option)
{
	Godot::gdnative_init(option);
}

extern "C" void GDN_EXPORT adxle_gdnative_terminate(godot_gdnative_terminate_options *option)
{
	Godot::gdnative_terminate(option);
}

extern "C" void GDN_EXPORT adxle_nativescript_init(void *handle)
{
